          ...
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10">
            ...
            <div>
              ...
              <ul class="space-y-3 text-sm">
                ...
                <li><a href="/careers"      class="text-white hover:text-brand-blue transition-colors">Careers</a></li>
          ...
          <div class="flex flex-col sm:flex-row justify-between items-center gap-5">
            ...
            <div class="flex items-center gap-5">
              <a href="/" aria-label="VertoDigital home">
                <img src="/images/logos/vertodigital-logo-light.svg" alt="VertoDigital" class="h-7 w-auto" loading="lazy" />
              </a>
